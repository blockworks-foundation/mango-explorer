...
from .fakes import fake_account_info, fake_seeded_public_key, fake_token_info, fake_instrument_value, fake_perp_account
...
def test_construction() -> None:
    ...
    basket = [
        mango.AccountSlot(fake_token_info(), fake_token_info(), raw_deposit1, deposit1, raw_borrow1, borrow1,
                          fake_seeded_public_key("spot openorders 1"), perp1),
        ...
        mango.AccountSlot(fake_token_info(), fake_token_info(), raw_deposit3, deposit3, raw_borrow3, borrow3,
                          fake_seeded_public_key("spot openorders 3"), perp3),
    ]
