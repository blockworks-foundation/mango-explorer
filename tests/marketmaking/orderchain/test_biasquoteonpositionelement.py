...
from ...fakes import fake_context, fake_inventory, fake_model_state, fake_order, fake_price
...
def test_single_bias_two_order_pairs() -> None:
    ...
    buy1: mango.Order = fake_order(price=Decimal(80), quantity=Decimal(1), side=mango.Side.BUY)
    buy2: mango.Order = fake_order(price=Decimal(90), quantity=Decimal(2), side=mango.Side.BUY)
    sell1: mango.Order = fake_order(price=Decimal(110), quantity=Decimal(2), side=mango.Side.SELL)
    sell2: mango.Order = fake_order(price=Decimal(120), quantity=Decimal(1), side=mango.Side.SELL)
    ...
    assert result[1].price == Decimal("109.45")  # 110 * (1 + (10 / 2) * -0.001) == 109.45
...
def test_three_biases_three_order_pairs() -> None:
    ...
    buy1: mango.Order = fake_order(price=Decimal(70), quantity=Decimal(1), side=mango.Side.BUY)
    buy2: mango.Order = fake_order(price=Decimal(80), quantity=Decimal(2), side=mango.Side.BUY)
    buy3: mango.Order = fake_order(price=Decimal(90), quantity=Decimal(3), side=mango.Side.BUY)
    sell1: mango.Order = fake_order(price=Decimal(110), quantity=Decimal(3), side=mango.Side.SELL)
    sell2: mango.Order = fake_order(price=Decimal(120), quantity=Decimal(2), side=mango.Side.SELL)
    sell3: mango.Order = fake_order(price=Decimal(130), quantity=Decimal(1), side=mango.Side.SELL)
    ...
    assert f"{result[1].price:.8f}" == "109.63333333"  # 110 * (1 + (10 / 3) * -0.001) == 109.6333333333
