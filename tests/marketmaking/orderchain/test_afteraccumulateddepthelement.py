...
def test_bid_price_updated_at_instead_of_after() -> None:
    ...
    actual: AfterAccumulatedDepthElement = AfterAccumulatedDepthElement(None, Decimal(0))
    result = actual.process(context, model_state, [order])
...
def test_bid_price_updated_at_instead_of_after_fixed_depth() -> None:
    ...
    actual: AfterAccumulatedDepthElement = AfterAccumulatedDepthElement(Decimal(3), Decimal(0))
    result = actual.process(context, model_state, [order])
